...
%cd /content/Intro_to_genAI

# Remove the file and replace with a real folder
!rm Introduction_to_gen_ai
!mkdir Introduction_to_gen_ai
!touch Introduction_to_gen_ai/.gitkeep

!git add .
!git commit -m "Convert Introduction_to_gen_ai to a directory"
!git push